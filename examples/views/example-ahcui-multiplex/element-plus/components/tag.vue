<template>
	...
	<div class="tag-group my-2">
		...
		<el-tag v-for="item in items" :key="item.label" class="mx-1" :type="item.type" effect="dark">
			{{ item.label }}
		</el-tag>
		<el-tag v-for="item in items" :key="item.label" class="mx-1" :type="item.type" effect="dark" closable>
			{{ item.label }}
		</el-tag>
	</div>
	<div class="tag-group my-2">
