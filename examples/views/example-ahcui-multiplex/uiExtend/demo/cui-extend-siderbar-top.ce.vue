...
<template>
    <div class="cui-siderbar-inner-top marked_box" v-if="!style.sideBarCollapse">
        <el-icon :size="40"><burger /></el-icon>
        <div class="sysName">自定义侧边栏头部内容</div>
    </div>
    <div class="cui-siderbar-inner-collapse-top" v-else>
        <el-icon :size="40"><burger /></el-icon>
...
<style scoped>
.cui-siderbar-inner-top,
.cui-siderbar-inner-collapse-top
{
