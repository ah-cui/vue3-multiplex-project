			...
			<el-card shadow="never" body-style="padding: 15px 20px 25px 20px;">
				<div style="max-width: 700px;margin: 0 auto;">
					...
					<el-form v-if="active===1" ref="formStep2" :model="form2" :rules="rules2" :size="formSize"
						label-width="100px" class="el-form-detail">
						<el-alert title="确认转账后，资金将直接打入对方账户，无法退回。" type="info" show-icon class="el-alert-border"
					...
					<div v-if="active===2">
						...
						<div class="el-result-extra el-bg-base el-bg-info-lighter">
							<el-form label-width="100px" :size="formSize" class="el-form-detail">
								<el-form-item label="付款账户:">
									<span>{{ form1.account}}</span>
								</el-form-item>
				...
				<div v-if="active===0">
					...
					<el-alert type="info" :closable="false" class="el-alert-border el-scope-description-size">
						<h6>说明</h6>
						<h6>转账到支付宝</h6>
						<p>
