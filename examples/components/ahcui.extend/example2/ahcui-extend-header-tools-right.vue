        ...
        <teleport :to="domSelect">
            <el-tooltip effect="dark" content='' placement="bottom">
                ...
                <el-tooltip effect="dark" content='' placement="bottom">
                    ...
                    <div class="cui-header-tools-item" title="未读消息" @click="showUnReadMsg = true">
...
export default {
    ...
    setup() {
        ...
        const fullScreen=vue.ref(false),showUnReadMsg=vue.ref(false),input=vue.ref(""),_isInCui=vue.ref(false),domSelect=".cui-multiplex .cui-header .cui-header-other cui-extend-header-tools-right";
