        ...
        <teleport :to="domSelect">
            <el-tooltip effect="dark" content='' placement="bottom">
                <template #content>
                    ...
                    <p>-->该扩展文件请见模板工程\"examples\components\ahcui.extend\example2\ahcui-extend-header-tools-left.vue"文件</p>
                </template>
...
export default {
    ...
    props:{},
    setup() {
        let input=vue.ref(""),_isInahcui=vue.ref(false),domSelect=".ahcui-multiplex .ahcui-header .ahcui-header-other ahcui-extend-header-tools-left";
