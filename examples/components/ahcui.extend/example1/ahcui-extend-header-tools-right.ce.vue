...
<template>
    <el-tooltip effect="dark" placement="top">
        <template #content>
                    ...
                    <p>-->该扩展文件请见模板工程\"examples\components\ahcui.extend\example1\ahcui-extend-header-tools-right.ce.vue"文件</p>
        </template>
    ...
    <el-tooltip effect="dark" placement="top">
        ...
        <div class="ahcui-header-tools-item" :title="未读消息" @click="fullScreen = Screen.screenSwitch()">
...
export default {
    components:{FullScreen,Crop,Bell,ElIcon},
    props:{},
    setup() {
...
.ahcui-header-tools-item .el-icon
{
font-weight: 700;
}
</style>
